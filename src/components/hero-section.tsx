...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] border border-[#C9A66B]/20 bg-[#F6F1E9] p-6 shadow-[0_30px_90px_rgba(46,94,78,0.06)] sm:p-10 lg:p-14">
      {/* Decorative Floating Lavender & Botanical Accents */}
      ...
      <div className="pointer-events-none absolute -right-6 bottom-8 h-36 w-36 animate-float opacity-70 z-10" style={{ animationDelay: "2s" }}>
        <svg viewBox="0 0 100 100" className="h-full w-full">
          <path d="M50 90 Q30 70 50 50 Q70 30 50 10 M35 70 Q20 65 30 80 M65 55 Q80 50 70 65" stroke="#7A9474" strokeWidth="3" fill="none" />
          <circle cx="25" cy="68" r="5" fill="#7A9474" />
          <circle cx="75" cy="52" r="5" fill="#C9A66B" />
        </svg>
      </div>
      ...
      <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left z-20">
          ...
          <h1 className="mt-6 max-w-2xl text-4xl font-bold leading-tight text-[#2E5E4E] sm:text-5xl lg:text-6xl font-serif">
            Nature&apos;s Embrace,<br className="hidden sm:inline" /> Handcrafted for Radiance.
          </h1>

          <p className="mt-6 max-w-xl text-base leading-relaxed text-[#1F332B]/80 sm:text-lg">
            Discover artisanal bath bars, shampoos, and flora elixirs crafted with goat milk, herbal botanicals, and the soothing touch of nature.
          </p>

          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            <Link href="/shop">
              <Button className="gap-2 px-8 py-6 text-xs font-bold uppercase tracking-widest bg-[#C9A66B] text-[#2E5E4E] hover:bg-[#2E5E4E] hover:text-[#FAF8F3] rounded-full shadow-lg transition duration-300">
          ...
          <div className="mt-10 flex items-center gap-4 border-t border-[#2E5E4E]/10 pt-6">
            ...
            <p className="text-xs font-semibold text-[#1F332B]/80">
              <span className="font-bold text-[#2E5E4E]">4.9 / 5.0</span> (1,240+ Verified Reviews)
            </p>
          </div>
        </div>

        {/* Hero Visual Mockup Container (Milk splash & soap bar stack) */}
        <div className="relative overflow-hidden rounded-[2.25rem] bg-white p-4 shadow-xl border border-[#C9A66B]/20">
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[1.75rem] bg-[#FAF8F3]">
            <Image
              src="https://images.unsplash.com/photo-1607006482602-765180037159?auto=format&fit=crop&w=1200&q=80"
              alt="Nature's Embrace Handcrafted Soap Bars"
              fill
              priority
            ...
            <div className="absolute inset-x-4 bottom-4 rounded-2xl bg-white/90 p-4 backdrop-blur-md border border-white/50 shadow-lg flex items-center justify-between">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#C9A66B]">Featured Soap</span>
                <p className="text-xs font-bold text-[#2E5E4E]">Goat Milk & Lavender Bath Bar</p>
              </div>
              <Link
                href="/shop"
